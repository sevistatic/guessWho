...
public class RandomPortrait
{
  ...
  /** Public method for creating readable String descriptions of features in a
   * corresponding array of ints
   * @param f an int array containing legal feature numbers, beginning at 1, and
   * usually ending in 2, 3, 5, or 10, depending on the feature
   * @return an array of descriptive strings about the corresponding features,
  ...
  // ----------------------------------------------------------------
  /** Creates an int[] of random integers corresponding to the parity values of
   * each feature. Runs forciblyGeneratePictures() based on this array.
   * @return an array of ImageIcons (in the proper order) of randomly assembled
   * portrait features. */
  private ImageIcon[] randomlyGeneratePictures()
  {
    ...
    {// girl, none for beard and mustache
      randF[6] = 2;
      randF[7] = 2;
    }
   ...
   * @param f an array of integers of proper parity corresponding to desired
   * features
   * @return an ordered array of ImagIcons corresponding to a single
   * portrait. */
  ...
  private String describeSkin(int f)
  {
    ...
    { // skin
    case 1:
      return "light skin";// light
    case 2:
      return "dark skin";// dark
    default:
      return "skin type error";
    }
  }
  ...
  private String describeEyes(int f)
  {
    ...
    { // eyes
    case 1:
      return "blue eyes";// blue
    case 2:
      return "black eyes";// black
    case 3:
      return "brown eyes";// brown
    case 4:
      return "green eyes";// green
    case 5:
      return "grey eyes";// grey
    default:
  ...
  private String describeSmile(int f)
  {
    ...
    { // smile
    case 1:
      return "smiling";// smile
    case 2:
      return "frowning";// frown
    default:
      return "smile error";
    }
  }
  ...
  private String describeLips(int f)
  {
    ...
    { // lips
    case 1:
      return "big lips";// big lips
    case 2:
      return "thin lips";// thin lips
    default:
      return "lips error";
    }
  }
  ...
  private String describeHair(int f)
  {
    ...
    { // hair
    case 1:
      return "blonde hair";// blonde
    case 2:
      return "black hair";// black
    case 3:
      return "brown hair";// brown
    case 4:
      return "red hair";// red
    case 5:
      return "grey hair";// grey
    case 6:
      return "bald";// bald
    default:
  ...
  private String describeMustache(int f)
  {
    ...
    case 2:
      return "no mustache";// no mustache
    default:
  ...
  private String describeShirt(int f)
  {
    ...
    case 6:
      return "yellow shirt";
    /*
     * case 7: return "purple shirt"; case 8: return "white shirt"; case 9:
     * return "leopard shirt"; case 10: return "warning shirt";
     */
    default:
      return "shirt error";
    }
  ...
  /*
   * private String describeHatStyle(int f){ switch (f){ //hat style case 1:
   * return "baseball cap"; case 2: return "cowboy hat"; case 3: return "beret";
  ...
  /*
   * private String describeGlassesStyle(int f){ switch (f){ //glasses style
   * case 1: return "thin glasses"; case 2: return "thick glasses"; case 3:
   * return "eyepatch"; case 4: return "monocle"; default: return
   * "glasses - none"; } }
   */
  ...
  private ImageIcon getSkinColor(int i)
  {
    ...
    if (i == 1)
    {
      ...
      {
      case 0:
        return new ImageIcon(foldername + "lightskin1.png");
      case 1:
        return new ImageIcon(foldername + "lightskin2.png");
      default:
        return new ImageIcon(foldername + "lightskin3.png");
      }
    } else
    {
      switch (kind)
      {
      case 0:
        return new ImageIcon(foldername + "darkskin1.png");
      case 1:
        return new ImageIcon(foldername + "darkskin2.png");
      default:
        return new ImageIcon(foldername + "darkskin3.png");
      }
    }
  }
  ...
  private ImageIcon getSex(int i)
  {
    ...
    if (i == 1)
    {
      ...
      {
      case 1:
        return new ImageIcon(foldername + "boy.png");
      default:
        return new ImageIcon(foldername + "boy2.png");
      }
    ...
    } else
    {
      ...
      {
      case 1:
        return new ImageIcon(foldername + "girl.png");
      default:
        return new ImageIcon(foldername + "girl2.png");
      }
    }
  }
  ...
  {
    if (s != 2)
    {// only men have beards or mustaches, usually
      if (i == 1)
      {// has a beard
        switch (k)
        {
