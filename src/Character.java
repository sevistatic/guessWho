...
class Character
{
  ...
  /** an ordered set of semi-transparent images. when displayed in this order
   * will form a coherent portrait.
  ...
  /** creates a new set of features from scratch based upon commonly found
   * features in the real world. For instance, girls are rarely bald, and rarely
   * have beards or mustaches.
